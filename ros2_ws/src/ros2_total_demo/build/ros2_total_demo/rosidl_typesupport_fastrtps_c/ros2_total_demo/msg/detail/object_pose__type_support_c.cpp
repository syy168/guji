...
#include "ros2_total_demo/msg/detail/object_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_total_demo/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ObjectPose__ros_msg_type = ros2_total_demo__msg__ObjectPose;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_total_demo
size_t get_serialized_size_ros2_total_demo__msg__ObjectPose(
  const void * untyped_ros_message,
...
static uint32_t _ObjectPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_total_demo__msg__ObjectPose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_total_demo
size_t max_serialized_size_ros2_total_demo__msg__ObjectPose(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ros2_total_demo__msg__ObjectPose(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_total_demo, msg, ObjectPose)() {
