...
{
  new (message_memory) ros2_total_demo::msg::ObjectPose(_init);
}

void ObjectPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_total_demo::msg::ObjectPose *>(message_memory);
  typed_message->~ObjectPose();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectPose_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(ros2_total_demo::msg::ObjectPose, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_total_demo::msg::ObjectPose, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_total_demo::msg::ObjectPose, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectPose_message_members = {
  "ros2_total_demo::msg",  // message namespace
  "ObjectPose",  // message name
  3,  // number of fields
  sizeof(ros2_total_demo::msg::ObjectPose),
...
{
  return &::ros2_total_demo::msg::rosidl_typesupport_introspection_cpp::ObjectPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_total_demo, msg, ObjectPose)() {
  return &::ros2_total_demo::msg::rosidl_typesupport_introspection_cpp::ObjectPose_message_type_support_handle;
}
