...
class RealSensePublisher(Node):
    def __init__(self, serial_number, width, height, fps):
        super().__init__('realsense_publisher1')
        ...
        self.color_publisher = self.create_publisher(Image, 'camera/color/image_raw1', 10)
        self.depth_publisher = self.create_publisher(Image, 'camera/depth/image_raw1', 10)
...
def main(args=None):
    ...
    # 自动选择第一个设备
    selected_serial = devices[1]['serial']
