...
class RealSensePublisher(Node):
    def __init__(self, serial_number, width, height, fps):
        super().__init__('realsense_publisher0')
        ...
        self.color_publisher = self.create_publisher(Image, 'camera/color/image_raw0', 10)
        self.depth_publisher = self.create_publisher(Image, 'camera/depth/image_raw0', 10)
