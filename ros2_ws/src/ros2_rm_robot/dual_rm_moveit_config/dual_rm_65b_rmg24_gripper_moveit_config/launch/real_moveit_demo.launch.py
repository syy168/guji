...
def generate_launch_description():
    ...
    # Load controllers "joint_state_broadcaster",
    load_controllers = []
    for controller in ["left_arm_controller","right_arm_controller","platform_controller","left_rmg24_gripper_controller","right_rmg24_gripper_controller"]:
        load_controllers += [
            ExecuteProcess(
