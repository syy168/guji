...
def generate_launch_description():
    ...
    left_arm_config = os.path.join(get_package_share_directory('rm_driver'), 'config', 'dual_65_left_config.yaml')
    right_arm_config = os.path.join(get_package_share_directory('rm_driver'), 'config', 'dual_65_right_config.yaml')
